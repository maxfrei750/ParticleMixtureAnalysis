...
def study_confusion_matrix_proposed_method():
    config_name_target = "Manual"
    config_name_prediction = "MultiClassSynthetic400SyntheticValidation400Detections"
    ...
    # Compensate "unfair" advantage of the proposed method, when compared to the Hough transform.
    confusion_matrix["background"]["background"] = 0
...
if __name__ == "__main__":
    study_confusion_matrix_proposed_method()
